...
function edgeBase(path) {
  ...
  if (clean.startsWith('/api/parcels/') || clean.startsWith('/api/parcel-context/') || clean.startsWith('/api/parcel-documents/') || CORE_PATHS.includes(clean)) return CORE_API_BASE;
  return '';
}
