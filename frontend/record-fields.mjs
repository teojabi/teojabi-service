const building=`대지위치 시군구코드명 법정동코드명 대지구분코드명 주지번 부지번 특수지명 블록번호 로트번호 새주소도로코드명 새주소법정동코드명 새주소지상지하구분코드명 새주소주지번 새주소부지번 건축물대장일련번호 대장구분코드명 대장종류코드명 동명 주부속구분코드명 대지면적 건축면적 건폐율 연면적 용적률산정연면적 용적률 구조코드명 기타구조정보 주용도코드 주용도코드명 기타용도내용 지붕코드명 기타지붕명 세대수 가구수 호수 지상층수 지하층수 높이 승용승강기수 비상용승강기수 주건축물수 부속건축물수 부속건축물면적 총동연면적 총주차수 옥내기계식대수 옥내기계식면적 옥외기계식대수 옥외기계식면적 옥내자주식대수 옥내자주식면적 옥외자주식대수 옥외자주식면적 허가일자 착공일자 사용승인일자 에너지효율등급값 에너지절감률 epi점수 친환경건축물등급값 친환경건축물인증점수 지능형건축물등급값 지능형건축물인증점수 내진설계적용여부 내진능력내용`.split(' ');
