...
exports.PublicDataModule = PublicDataModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [public_data_service_1.PublicDataService],
        controllers: [public_data_controller_1.PublicDataController],
        exports: [public_data_service_1.PublicDataService],
    })
], PublicDataModule);
